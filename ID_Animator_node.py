...
class ID_Animator:
    ...
    def id_animator(self, image, prompt, negative_prompt, clip_token_model, clip_text_model, vae_model, unet_model,
                    model_local_path, scheduler,
        ...
        animator = self.load_model(inference_config, clip_token_model, clip_text_model, vae_model, unet_model, scheduler, id_ckpt, image_encoder_path,
